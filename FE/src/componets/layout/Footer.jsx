      ...
      <footer className="bg-neutral-900 text-white py-10 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div className="space-y-4 text-center sm:text-left">
                  <img src="/img/logo.png" alt="Personal Logo" className="h-10 mx-auto sm:mx-0"/>
              ...
              <div className="text-center sm:text-left">
                  ...
                  <ul className="space-y-1 text-sm text-gray-300">
                      ...
                      <li className="flex items-center justify-center sm:justify-start gap-2">
                          ...
                          <span>thangtran51111@gmail.com</span>
                      </li>
                      <li className="mt-4 flex justify-center sm:justify-start gap-4 text-lg">
